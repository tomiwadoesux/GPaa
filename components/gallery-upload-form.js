...
import { CalendarIcon, SpinnerIcon, CheckIcon, HeartIcon, UploadIcon } from "./icons"
      ...
      <div className="relative z-10">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl">
            Contribute to our visual history. Your photos help preserve cherished moments and bring communities together.
          </p>
        </div>
        ...
        {isSuccess ? (
          <div className="relative group">
            ...
            <div className="relative flex items-start gap-4 bg-card border border-secondary/20 rounded-2xl p-6 backdrop-blur-sm">
              ...
              <div className="flex-1">
                <p className="font-bold text-lg text-foreground mb-1">Thank You!</p>
                <p className="text-muted-foreground">
                  Your photo has been submitted successfully and will be reviewed shortly. It will appear in the gallery soon.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <label htmlFor="year" className="block text-sm font-bold text-foreground mb-3 uppercase tracking-wide">
            ...
            {/* Description */}
            <div>
              <label htmlFor="description" className="block text-sm font-bold text-foreground mb-3 uppercase tracking-wide">
