            ...
            <div className="mt-20 pt-16 border-t border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-lg bg-secondary/5 border border-secondary/10">
                  ...
                  <p className="text-muted-foreground font-medium">Testimonies Shared</p>
                </div>
                <div className="text-center p-6 rounded-lg bg-secondary/5 border border-secondary/10">
                  <div className="text-4xl font-bold text-secondary mb-2">
                    {new Set(displayTestimonials.map(t => t.relationship)).size}
                  </div>
                  <p className="text-muted-foreground font-medium">Circles of Influence</p>
                </div>
                <div className="text-center p-6 rounded-lg bg-secondary/5 border border-secondary/10">
                  <div className="text-4xl font-bold text-secondary mb-2">
                    ∞
                  </div>
                  <p className="text-muted-foreground font-medium">Lasting Legacy</p>
                </div>
              </div>
            </div>
          </div>
